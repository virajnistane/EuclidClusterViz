...
class TestClusterVisualizationCore(unittest.TestCase):
    ...
    def test_run_basic(self):
        ...
        with patch.object(self.core, "open_browser") as mock_open_browser:
            with patch("builtins.print"):  # Suppress print output
                ...
                self.core.run(
                    host="localhost", port=8050, debug=False, auto_open=True, external_access=False
                )
    ...
    def test_run_external_access(self):
        ...
        with patch.object(self.core, "open_browser") as mock_open_browser:
            with patch("builtins.print"):  # Suppress print output
                ...
                self.core.run(
                    host="localhost", port=8050, debug=False, auto_open=True, external_access=True
                )
    ...
    def test_try_multiple_ports_address_in_use(self):
        ...
        with patch.object(self.core, "run") as mock_run:
            ...
            mock_run.side_effect = [OSError("Address already in use"), None]  # Second call succeeds
